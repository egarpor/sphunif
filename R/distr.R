...
#' distribution within a spherical cap of angle \eqn{0\leq \theta\leq \pi} about
...
#' \eqn{r=\cos(\theta)} is the projected radius of the spherical cap about
...
#' @param angle angle \eqn{\theta} defining the spherical cap about
