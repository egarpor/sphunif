...
[![Travis build status](https://travis-ci.org/egarpor/sphunif?branch=master)](https://travis-ci.org/egarpor/sphunif)
[![CRAN status](https://www.r-pkg.org/badges/version/sphunif)](https://cran.r-project.org/package=sphunif)
<!-- badges: end -->
