...
reproduces the data application in García-Portugués, Navarro-Esteban,
and Cuesta-Albertos (2023) regarding the testing of uniformity of
locations for craters in Rhea. The code snippet below is a simplified
version.
...
reproduces the data application in García-Portugués, Navarro-Esteban,
and Cuesta-Albertos (2021) regarding the testing of the uniformity of
locations for craters in Venus.
...
contains some of the simulations in Fernández-de-Marcos and
...
reproduces the data application in García-Portugués, Paindaveine, and
Verdebout (2025) regarding the symmetry of comet orbits.
...
García-Portugués, and Verdebout (2025). The script
[data-application-sobolev-hd.R](https://github.com/egarpor/sphunif/blob/master/applications/data-application-sobolev-hd.R)
reproduces the data application regarding the testing of Gaussianity of
the CMB field.
