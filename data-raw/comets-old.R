...
## DEPRECATED SCRIPT! The NASA's JPL small-body database changed its search
## engine interface, its API and some of its internals in August 2021,
## resulting in the current script (produced in 2020) not being reproducible
## anymore. See comets.R instead.
...
# Save object
save(list = "comets", file = "comets-old.rda", compress = "bzip2")
